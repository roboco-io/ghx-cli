...
// TestDiscussionList tests the 'ghx discussion list' command
func TestDiscussionList(t *testing.T) {
	cfg := GetTestConfig(t)
	repoArg := fmt.Sprintf("%s/%s", cfg.Owner, cfg.Repo)

	t.Run("list discussions", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", repoArg)
	...
	t.Run("list discussions with limit", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", repoArg, "--limit", "5")
		result.AssertSuccess(t)
	})

	t.Run("list discussions with json format", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", repoArg, "--format", "json")
		result.AssertSuccess(t)
	...
	t.Run("list discussions with state filter", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", repoArg, "--state", "open")
		result.AssertSuccess(t)
	})

	t.Run("list discussions with invalid repo format", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", "invalid-repo-format")
		result.AssertFailure(t)
		result.AssertErrorContains(t, "invalid repository format")
	})
}

// TestDiscussionCategoryList tests the 'ghx discussion category list' command
func TestDiscussionCategoryList(t *testing.T) {
	cfg := GetTestConfig(t)
	repoArg := fmt.Sprintf("%s/%s", cfg.Owner, cfg.Repo)

	t.Run("list categories", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "category", "list", repoArg)
		result.AssertSuccess(t)
	...
	t.Run("list categories with json format", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "category", "list", repoArg, "--format", "json")
		result.AssertSuccess(t)
	})
}

// TestDiscussionView tests the 'ghx discussion view' command
func TestDiscussionView(t *testing.T) {
	cfg := GetTestConfig(t)
	repoArg := fmt.Sprintf("%s/%s", cfg.Owner, cfg.Repo)

	// First, get a valid discussion number from list
	listResult := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", repoArg, "--format", "json")
	...
	t.Run("view discussion", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "view", repoArg, discussionNumber)
		result.AssertSuccess(t)
		result.AssertOutputContains(t, "#"+discussionNumber)
	})

	t.Run("view discussion with json format", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "view", repoArg, discussionNumber, "--format", "json")
		result.AssertSuccess(t)
		result.AssertOutputContains(t, "\"number\"")
	})

	t.Run("view non-existent discussion", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "view", repoArg, "999999")
		result.AssertFailure(t)
	})

	t.Run("view discussion with invalid number", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "view", repoArg, "not-a-number")
		result.AssertFailure(t)
...
func TestDiscussionCRUDWorkflow(t *testing.T) {
	...
	if os.Getenv("GHX_E2E_WRITE_TESTS") != "1" {
		t.Skip("Write tests disabled (set GHX_E2E_WRITE_TESTS=1 to enable)")
	}
	...
	catResult := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "category", "list", repoArg, "--format", "json")
	...
	t.Run("create discussion", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout,
...
func TestDiscussionCommandHelp(t *testing.T) {
	...
	for _, cmd := range commands {
		t.Run(fmt.Sprintf("help for %q", cmd), func(t *testing.T) {
			...
			result := cfg.RunGHXWithTimeout(commandTimeout, args...)
			result.AssertSuccess(t)
...
func TestDiscussionAliases(t *testing.T) {
	...
	t.Run("disc alias works", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "disc", "list", repoArg)
		result.AssertSuccess(t)
	})

	t.Run("discussions alias works", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussions", "list", repoArg)
		result.AssertSuccess(t)
	})
}
...
func TestDiscussionErrorHandling(t *testing.T) {
	...
	t.Run("missing repo argument", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list")
		result.AssertFailure(t)
	})

	t.Run("missing number argument for view", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "view", "owner/repo")
		result.AssertFailure(t)
	})
	...
	t.Run("invalid state value", func(t *testing.T) {
		...
		_ = cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", "owner/repo", "--state", "invalid")
	})

	t.Run("invalid format value", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", "owner/repo", "--format", "xml")
		result.AssertFailure(t)
	})
}
...
func TestDiscussionOutputFormats(t *testing.T) {
	...
	listResult := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", repoArg, "--limit", "1")
	if strings.Contains(listResult.Stdout, "No discussions found") {
		t.Skip("No discussions available to test output formats")
	}

	t.Run("table format", func(t *testing.T) {
		result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", repoArg, "--format", "table")
		result.AssertSuccess(t)
...
func TestDiscussionPagination(t *testing.T) {
	...
	result := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", repoArg, "--limit", "100", "--format", "json")
	result.AssertSuccess(t)
	...
	// Get with limit 1
	limitedResult := cfg.RunGHXWithTimeout(commandTimeout, "discussion", "list", repoArg, "--limit", "1", "--format", "json")
...
func BenchmarkDiscussionList(b *testing.B) {
	...
	token := os.Getenv("GHX_TEST_TOKEN")
	if token == "" {
